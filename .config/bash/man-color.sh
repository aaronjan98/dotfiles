...
# Force groff to output old-style overstrike formatting instead of SGR
# escape sequences. This is required for less to use the LESS_TERMCAP_*
# variables below — without it, groff sends its own ANSI codes directly
# and less just passes them through, ignoring our custom colors.
...
# Make less interpret ANSI escape sequences (color)
export LESS=-R