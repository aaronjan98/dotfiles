...
1. Read: ~/.config/ai/shared/tool-commands.md

2. Check the current working directory for these files and read any that exist:
   - CONTEXT.md
   - MEMORY.md
   - DEPENDENCIES.md

3. If no CONTEXT.md exists here, check ~/Repositories/ROUTER.md to orient.

4. Do not load unrelated repositories or search broadly without routing.
